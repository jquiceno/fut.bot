...
export class NestjsGrammyModule extends GrammyConfigurableModuleClass implements OnApplicationShutdown {
  ...
  static forRoot(options: typeof GRAMMY_OPTIONS_TYPE): DynamicModule {
    ...
    return {
      providers: [...(providers ?? []), grammyBotNameProvider, grammyBotProvider],
